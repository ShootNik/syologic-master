...
RESOURCES += src/qt/syologic.qrc src/qt/syologic_locale.qrc

TRANSLATIONS += src/qt/locale/syologic_bg.ts \
                src/qt/locale/syologic_de.ts \
                src/qt/locale/syologic_en.ts \
                src/qt/locale/syologic_es.ts \
                src/qt/locale/syologic_fi.ts \
                src/qt/locale/syologic_fr.ts \
                src/qt/locale/syologic_it.ts \
                src/qt/locale/syologic_ja.ts \
                src/qt/locale/syologic_pl.ts \
                src/qt/locale/syologic_pt.ts \
                src/qt/locale/syologic_ru.ts \
                src/qt/locale/syologic_sk.ts \
                src/qt/locale/syologic_sv.ts \
                src/qt/locale/syologic_vi.ts \
                src/qt/locale/syologic_zh_CN.ts \
                src/qt/locale/syologic_zh_TW.ts
