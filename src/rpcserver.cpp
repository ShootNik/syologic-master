...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop SyoLogic server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "SyoLogic server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SYO features */
        {"syologic", "masternode", &masternode, true, true, false},
        {"syologic", "masternodelist", &masternodelist, true, true, false},
        {"syologic", "mnbudget", &mnbudget, true, true, false},
        {"syologic", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"syologic", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"syologic", "mnsync", &mnsync, true, true, false},
        {"syologic", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"syologic", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use syologicd, or the -server option to syologic-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"SyoLogic Alert\" admin@foo.com\n"),
...
{
    return "> syologic-cli " + methodname + " " + args + "\n";
}
