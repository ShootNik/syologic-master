...
/** Utility functions used by the SYO Qt UI.
 */
namespace GUIUtil
{
...
// Render SYO addresses in monospace font
...
// Parse "syologic:" URI into recipient object, return true on successful parsing
