                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SyoLogic-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SyoLogic address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and syologic: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SyoLogic Core"), this);
    aboutAction->setStatusTip(tr("Show information about SyoLogic Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SyoLogic"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SyoLogic addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SyoLogic addresses"));
    ...
    openAction->setStatusTip(tr("Open a SyoLogic: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SyoLogic Core help message to get a list with possible SyoLogic command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SyoLogic Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SyoLogic network", "", count));
}
...
{
    QString strTitle = tr("SyoLogic Core"); // default title
