...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("SyoLogic Core"),
     ...
     * override -datadir in the syologic.conf file in the default data directory
     * (to be consistent with syologicd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
