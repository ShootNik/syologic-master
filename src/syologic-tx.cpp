...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SyoLogic Core syologic-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  syologic-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded syologic transaction") + "\n" +
                               "  syologic-tx [options] -create [commands]   " + _("Create hex-encoded syologic transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded syologic transaction
