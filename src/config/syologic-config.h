/* src/config/syologic-config.h.  Generated from syologic-config.h.in by configure.  */
/* src/config/syologic-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://syologic.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "SyoLogic Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "SyoLogic Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "syologic"
